...
def calculate_subset_transverse_distributions(
    ...
    *,
    ...
    for i in range(bins):
        ...
        stats.append(calculate_transverse_distributions(particles_slice, axis, propagation_axis=propagation_axis))
...
def calculate_bunch_stats(
    ...
    if spectral_stats:
        ...
        spectral_stats_dict['charge'] = spectral_charge
        stats['spectral'] = spectral_stats_dict
    return stats
